...
clean:
	rm -f vector_benchmark vector_benchmark_arm64 vector_benchmark.s vector_benchmark_opt.s vector_benchmark_unopt.s vector_benchmark_annotated.s vector_benchmark_debug.s

.PHONY: all run clean asm asm-annotated asm-debug neon-check neon-check-annotated neon-functions compare-asm objdump-neon cpu-info debug-asm vector_benchmark_arm64
